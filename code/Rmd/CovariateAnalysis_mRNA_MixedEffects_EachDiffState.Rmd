...
storeFilesInSynapse <- function(covariates, processedCounts, 
  ...
  synSetAnnotations(COUNTS_OBJ) <- list(dataType="mRNA", fileType="genomicMatrix", 
                                        fileSubType="counts", Diffname_short=diffstate)
  ...
  synSetAnnotations(WEIGHTS_OBJ) <- list(dataType="mRNA", fileType="Weights", fileSubType="Adjusted",
                                         fixedEffects=voomExpr[[diffstate]]$postAdjustCovars,
  ...
  synSetAnnotations(COVARIATES_OBJ) <- list(dataType="mRNA", fileType="Covariates", fileSubType="Adjusted",
                                            fixedEffects=voomExpr[[diffstate]]$postAdjustCovars,
                                            randomEffects="Donor_ID", Diffname_short=diffstate)
  ...
  synSetAnnotations(DESIGN_OBJ) <- list(dataType="mRNA", fileType="Design", fileSubType="Adjusted",
                                        fixedEffects=voomExpr[[diffstate]]$postAdjustCovars,
                                        randomEffects="Donor_ID", Diffname_short=diffstate)
