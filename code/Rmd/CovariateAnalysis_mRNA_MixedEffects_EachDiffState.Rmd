...
storeFilesInSynapse <- function(covariates, PROCESSED_COUNTS, 
  ...
  # Store counts matrix
  COUNTS <- PROCESSED_COUNTS[[diffstate]]$filteredExprMatrix$counts
  ...
  colnames(WEIGHTS) <- c('GeneNames',
                         rownames(PROCESSED_COUNTS[[diffstate]]$filteredExprMatrix$samples))
  write.table(WEIGHTS,
  ...
  # Design Matrix
  DESIGN <- VOOM.GENE.EXPRESSION.POSTADJUSTED[[diffstate]]$GENE.EXPRESSION$design
