...
initialVoomNormalisation <- function(covariates, processed_counts){
  ...
  cat("----",
      paste('#### Differentiation state:',as.character(diffstate)),
      sep="")
...
plotGeneCovariatesCorrelation <- function(COVARIATES, VOOM.GENE.EXPRESSION.PREADJUSTED){
  ...
  preAdjustedSigCovars = runPCAandPlotCorrelations(VOOM.GENE.EXPRESSION.PREADJUSTED[[diffstate]]$GENE.EXPRESSION$E, 
                                                   DESIGN,
