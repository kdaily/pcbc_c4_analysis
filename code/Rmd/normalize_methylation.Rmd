...
write.table(beta, file='C4Meth450.tsv', quote=FALSE, sep='\t')
file <- File('C4Meth450.tsv', parentId='syn2813225', 
             name='Normalized methylation calls')
synSetAnnotations(file) <- list(dataType="methylation", fileType="matrix")

usedFiles <- subset(fileList, UID %in% sampleNames(RGSet))
