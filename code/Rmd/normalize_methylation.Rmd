...
idx <- match(colnames(RGSet), meta$prettyName)
...
subset(pData(RGSet), prettyName %in% removed, c("UID", "prettyName", "C4_Cell_Line_ID", "Diffname_short"))
```
...
file <- File('C4Meth450.tsv', parentId='syn1773109', name='Normalized Methylation calls')
