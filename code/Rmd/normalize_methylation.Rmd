...
file <- File('C4Meth450.tsv', parentId='syn2813225', name='Normalized methylation calls', annotations=list(dataType="methylation", fileType=""))
data <- synStore(file, used=fileList$id, executed=(script))
```
