...
knit2synapse::knitfile2synapse("./code/Rmd/DiffStatePaper/uniquedefeats.Rmd", 
...
```{r}
diffstateSpecificFeatures <- rbind(diffstateSpecificGenes, 
                                   diffstateSpecificmiRNAs,
                                   diffstateSpecificmethylation) 

write.csv(diffstateSpecificFeatures, file="diffstateSpecificFeatures.csv")
```
```{r synstore}
