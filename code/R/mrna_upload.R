...
queryString <- sprintf("select UID,id,parentId from file where projectId=='%s' and dataType=='mRNA' and fileType=='fastq'", projectId)
...
write.csv(mergedResults, "mrna_upload.csv")
